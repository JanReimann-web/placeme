...
export function createMockImageUrl({
  ...
  <svg xmlns="http://www.w3.org/2000/svg" width="1200" height="1600" viewBox="0 0 1200 1600" fill="none">
    ...
    <text x="120" y="260" fill="${palette.line}" font-size="124" font-family="Georgia, serif" font-weight="700">${scene.title}</text>
    <text x="120" y="330" fill="${palette.line}" opacity="0.88" font-size="42" font-family="Arial, sans-serif">${destinationLabel} • ${styleLabel}</text>
    <text x="120" y="416" fill="${palette.line}" opacity="0.72" font-size="32" font-family="Arial, sans-serif">${scene.description}</text>
    ...
    <text x="120" y="1208" fill="${palette.line}" font-size="60" font-family="Arial, sans-serif" font-weight="600">${participantLabel}</text>
    <text x="120" y="1292" fill="${palette.line}" opacity="0.74" font-size="30" font-family="Arial, sans-serif">${styleTone[style]}</text>
    <text x="120" y="1362" fill="${palette.line}" opacity="0.74" font-size="30" font-family="Arial, sans-serif">Wardrobe note: ${scene.wardrobeHint}</text>
